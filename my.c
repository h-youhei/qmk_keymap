...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = LAYOUT_ergodox(
		...
		KC_NO, KC_NO,
		KC_NO,
		IME, NUM_SIGN_T(KC_ENT), RSFT_T(KC_SPC)
	),
#ifdef ENABLE_STABLE_LAYER
	...
	[L_KANA] = LAYOUT_ergodox(
		// left hand
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, FN_T(KC_MHEN), KC_TRNS,
		KC_TRNS, KC_TRNS, IM_HIRAGANA, VOWEL_I(KANA_I), VOWEL_E(KANA_RU), VOWEL_YE(KANA_MA), KC_TRNS,
		...
		// right hand
		KC_TRNS, FN_T(KC_HENK), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	...
	[L_NUM_SIGN] = LAYOUT_ergodox(
		...
		KC_NO, KC_NO, KC_NO, JP_LCBR, JP_RCBR,
		// thumb
		KC_TRNS, KC_TRNS,
		KC_TRNS,
		KC_TRNS, KC_TRNS, KC_TRNS,
		// right hand
		KC_TRNS, KC_NO, RCTL_T(KC_7), RALT_T(KC_8), RGUI_T(KC_9), KC_TRNS, KC_TRNS,
	...
	[L_FN] = LAYOUT_ergodox(
		...
		KC_NO, KC_SLCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS,
		KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_NO,
		KC_APP, KC_NO, KC_NO, KC_NO, KC_NO, KC_PAUS, KC_TRNS,
