...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = LAYOUT_ergodox(
		// left hand
		IME, KC_1, KC_2, KC_3, KC_4, KC_5, KC_INS,
		...
		KC_PGUP, KC_PGDN,
		KC_PSCR,
		KC_SPC, KC_ENT, KC_MHEN,
		// right hand
		JP_YEN, KC_6, KC_7, KC_8, KC_9, KC_0, JP_MINS,
		JP_CIRC, KC_Y, KC_U, KC_I, KC_O, KC_P, JP_AT,
		KC_H, KC_J, KC_K, KC_L, JP_SCLN, JP_COLN,
		KC_DEL, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(JP_BSLS),
		KC_LEFT, KC_RGHT, RALT_T(JP_LBRC), RGUI_T(JP_RBRC), KC_RCTL,
		// thumb
		KC_HOME, KC_END,
		KC_KANA,
		KC_HENK, KC_BSPC, KC_SPC
	),
	[L_FN] = LAYOUT_ergodox(
		// left hand
		KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO,
		KC_NO, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_TRNS,
		...
		// right hand
		PRACTICE_MODE, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, CLEAR,
