...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = KEYMAP(
		...
		KC_SLCK, KC_X, KC_U, KC_L, KC_R, KC_F, SFT_T(KC_MUTE),
		KC_Z, KC_V, KC_A, KC_T, KC_N, KC_M,
		KC_BSLS, KC_SLSH, KC_EQL, KC_MINS, KC_H, KC_B, KC_PAUS,
		...
		SFT_T(KC_MPLY), KC_P, KC_C, KC_O, KC_Y, KC_J, KC_PSCR,
		KC_W, KC_S, KC_E, KC_I, KC_K, KC_Q,
		KC_PAUS, KC_G, KC_D, KC_COMM, KC_DOT, KC_QUOT, KC_SCLN,
