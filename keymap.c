...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = KEYMAP(
		...
		KC_SLCK, KC_X, KC_U, KC_O, KC_C, KC_P, SFT_T(KC_MUTE),
		KC_Z, KC_K, KC_A, KC_E, KC_S, KC_W,
		KC_BSLS, KC_QUOT, KC_SLSH, KC_MINS, KC_D, KC_G, KC_PAUS,
		...
		SFT_T(KC_MPLY), KC_F, KC_R, KC_L, KC_Y, KC_J, KC_PSCR,
		KC_M, KC_N, KC_T, KC_I, KC_V, KC_Q,
		KC_PAUS, KC_B, KC_H, KC_COMM, KC_DOT, KC_EQL, KC_SCLN,
