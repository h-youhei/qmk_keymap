...
#define ARRW_OS OSL(L_ARROW)
#define ARRW_TG TG(L_ARROW)
//#define SYMB_T(kc) LT(L_SYMBOL, kc)
#define SYMB_OS OSL(L_SYMBOL)
#define SYMB_TG TG(L_SYMBOL)
//#define NUM_T(kc) LT(L_SYMBOL, kc)
//#define FN_OS(kc) OSL(L_FUNCTION)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = KEYMAP(
		// left hand
		CLEAR, KC_NO, KC_HOME, KC_LBRC, KC_RBRC, KC_GRV, KC_NO,
		KC_NO, KC_J, KC_Y, KC_L, KC_R, KC_F, SFT_T(KC_MUTE),
		KC_Q, KC_V, KC_I, KC_T, KC_N, KC_M,
		KC_BSLS, KC_SLSH, KC_COMM, KC_DOT, KC_H, KC_B, ARRW_OS,
		KC_NO, KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT,
		// thumb
		WS_T(KC_ESC), CTL_T(KC_PGUP),
		GUI_T(KC_PGDN),
		ARRW_TG, ALT_T(KC_ENT), SYMB_TG,
		// right hand
		KC_NO, KC_INS, KC_BSPC, KC_DEL, KC_END, KC_NO, KC_NO,
		SFT_T(KC_MPLY), KC_P, KC_C, KC_O, KC_U, KC_X, KC_PSCR,
		KC_W, KC_S, KC_E, KC_A, KC_K, KC_Z,
		KC_PAUS, KC_G, KC_D, KC_MINS, KC_EQL, KC_QUOT, KC_SCLN,
		KC_RSFT, KC_RALT, KC_RGUI, KC_RCTL, KC_NO,
		// thumb
		CTL_T(KC_KANA), WS_T(KC_TAB),
		GUI_T(KC_CAPS),
		SYMB_OS, ALT_T(KC_SPC), SFT_OS
	),
	[L_SYMBOL] = KEYMAP(
		// left hand
	...
	[L_ARROW] = KEYMAP(
		...
		KC_TRNS, KC_NO, LALT(KC_NO), KC_APP, KC_SLCK, KC_NO, KC_NO,
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,
		// thumb
		KC_TRNS, KC_TRNS,
		KC_TRNS,
