...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = KEYMAP(
		// left hand
		KC_PSCR, KC_3, KC_2, KC_1, KC_5, KC_4, KC_MHEN,
		KC_MHEN, KC_Q, KC_C, KC_L, KC_P, KC_V, KC_ESC,
		KC_SLSH, KC_O, KC_S, KC_R, KC_N, KC_H,
		KC_WBAK, KC_X, KC_J, KC_MINS, KC_F, KC_B, KC_BSPC,
		KC_KANA, KC_NO, LGUI_S(KC_GRV), LCTL_S(KC_BSLS), LALT_S(KC_EQL),
		// thumb
		KC_RCLK, KC_LCLK,
		KC_MCLK,
		LSFT_S(KC_SPC), FN_S(KC_ENT), KC_CAPS,
		// right hand
		KC_HENK, KC_8, KC_9, KC_0, KC_6, KC_7, STABLE,
		KC_INS, KC_K, KC_G, KC_U, KC_Y, KC_Z, KC_HENK,
		KC_D, KC_T, KC_E, KC_I, KC_A, KC_SCLN,
		KC_DEL, KC_W, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_WBAK,
		RALT_S(KC_LBRC), RCTL_S(KC_RBRC), RGUI_S(KC_PAUS), KC_NO, KC_KANA,
		// thumb
		KC_LCLK, KC_RCLK,
		KC_MCLK,
		KC_CAPS, FN_S(KC_TAB), RSFT_S(KC_SPC)
		),
#ifdef ENABLE_STABLE_LAYER
	[L_STABLE] = KEYMAP(
		// left hand
